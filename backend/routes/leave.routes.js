...
router.post(
  ...
  [
    validateAllowedBodyFields(
      ["name", "description", "maxDaysPerYear", "carryForward"],
      "leave type creation"
    ),
    body("name")
      .isString()
    ...
    body("maxDaysPerYear")
      .isFloat({ min: 0, max: 366 })
      .withMessage("maxDaysPerYear must be between 0 and 366")
      .toFloat(),
    body("carryForward")
      .optional()
      .isBoolean({ strict: true })
      .withMessage("carryForward must be true or false")
      .toBoolean(),
  ],
  validateRequest,
  createLeaveType
...
router.put(
  ...
  [
    ...
    validateAllowedBodyFields(
      ["name", "description", "maxDaysPerYear", "carryForward", "isActive"],
      "leave type update"
    ),
    body().custom((value, { req }) => {
...
router.post(
  ...
  [
    validateAllowedBodyFields(
      ["userId", "leaveTypeId", "year", "allocated"],
    ...
    body("allocated")
      .isFloat({ min: 0, max: 366 })
      .withMessage("allocated must be between 0 and 366")
      .toFloat(),
  ],
  validateRequest,
  allocateLeaveBalance
...
router.get(
  "/all",
  authorizeRoles("hr", "admin"),
  leaveRequestQueryValidation(true),
  validateRequest,
  getOrganizationLeaveRequests
);
router.get(
...
router.put(
  ...
  [
    ...
    body("approverComment")
      .optional()
      .isString()
      .withMessage("Approver comment must be a string")
      .trim()
      .isLength({ max: 500 })
      .withMessage("Approver comment cannot exceed 500 characters"),
  ],
  validateRequest,
  approveLeaveRequest
);
router.put(
  ...
  [
    ...
    body("approverComment")
      ...
      .withMessage("Approver comment must be between 1 and 500 characters"),
  ],
  validateRequest,
  rejectLeaveRequest
);
