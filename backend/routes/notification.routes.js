...
const { getMyNotifications, markNotificationAsRead, markAllNotificationsAsRead, deleteNotification, testNotificationEmail } = require("../controllers/notification.controller");
...
router.patch("/:id/read", [param("id").isMongoId().withMessage("Invalid notification id")], validateRequest, markNotificationAsRead);
