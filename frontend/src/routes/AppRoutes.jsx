      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route element={<ProtectedRoute roles={["manager"]} />}>
            <Route path="/attendance/team" element={<AttendanceListPage scope="team" />} />
            <Route path="/leave/team" element={<LeaveListPage scope="team" />} />
          </Route>
          <Route element={<ProtectedRoute roles={["hr", "admin"]} />}>
            <Route
              path="/attendance/organization"
              element={<AttendanceListPage scope="organization" />}
            />
            <Route path="/leave/all" element={<LeaveListPage scope="organization" />} />
