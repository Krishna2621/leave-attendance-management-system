...
const PasswordInput = ({ label, error, visible, onToggle, ...props }) => (
  <div className="relative">
    ...
    <button
      type="button"
      onClick={onToggle}
      className="absolute right-3 top-9 rounded p-1 text-slate-500 transition hover:text-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-600/30"
...
export default function RegisterPage() {
  ...
  return (
    <main className="grid min-h-screen bg-slate-50 lg:grid-cols-2">
      <section className="hidden bg-teal-800 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="text-2xl font-bold">
          Leave<span className="text-teal-300">Flow</span>
        </div>
        <div>
          <p className="text-4xl font-bold leading-tight">Your workforce, in perfect flow.</p>
          <p className="mt-4 max-w-md text-teal-100">
            A simple, secure place for attendance, leave, and people operations.
          </p>
        </div>
        <p className="text-sm text-teal-200">Leave & Attendance Management System</p>
      </section>
      <section className="grid place-items-center p-6">
        ...
        >
          <div className="mb-8">
            <div className="mb-6 text-xl font-bold text-slate-900 lg:hidden">
              Leave<span className="text-teal-700">Flow</span>
            </div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Get started with your LeaveFlow workspace.
            </p>
          </div>
