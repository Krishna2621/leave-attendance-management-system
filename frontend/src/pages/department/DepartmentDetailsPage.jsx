  ...
  return (
    <div className="mt-6 space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <Card className="p-6 lg:col-span-1">
          ...
          <div className="mt-6 space-y-2 border-t border-slate-100 pt-5">
            ...
            {isAdmin && (
              <Button className="w-full" variant="danger" onClick={() => setDialog("delete")}>
                Delete department
              </Button>
            )}
          </div>
        ...
        <div className="space-y-5 lg:col-span-2">
          <Card className="p-6">
            ...
            <div className="divide-y divide-slate-100">
              ...
              <Row label="Status" value={department.isActive ? "Active" : "Inactive"} />
              <Row label="Department head" value={department.managerId?.name} />
              <Row label="Head email" value={department.managerId?.email} />
            </div>
          </Card>
          <Card className="p-6">
          ...
          <Card className="p-6">
            <h2 className="mb-2 font-semibold text-slate-900">Timeline</h2>
            <div className="divide-y divide-slate-100">
              <Row label="Created" value={formatDate(department.createdAt)} />
              <Row label="Last updated" value={formatDate(department.updatedAt)} />
            </div>
          </Card>
        </div>
      </div>
      ...
      <ConfirmDialog
        ...
        message={`Delete ${department.name}? This cannot be undone and only works if no employees are assigned.`}
        confirmLabel="Delete"
