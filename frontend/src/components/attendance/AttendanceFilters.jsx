...
export default function AttendanceFilters({ filters, onChange, scope }) {
  ...
  return (
    <form
      className="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 md:grid-cols-2 xl:grid-cols-5"
    ...
    >
      ...
      <label className="relative text-sm font-medium text-slate-700">
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-lg border border-slate-300 py-2 pl-9 pr-3 text-sm"
        />
      </label>
      <Button
        variant="secondary"
